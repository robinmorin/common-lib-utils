...
public class MapperJsonProvider implements Supplier<ObjectMapper> {
    ...
    private static class MapperPrototype implements SinglePrototype<ObjectMapper> {
        private final static List<?> onFeatures = List.of(SerializationFeature.ORDER_MAP_ENTRIES_BY_KEYS,
                SerializationFeature.WRITE_DATE_KEYS_AS_TIMESTAMPS,
                DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY);
        private final static List<?> offFeatures = List.of(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES,
